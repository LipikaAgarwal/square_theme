    ...
    <div class="container-fluid error-section">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-6 col-6 p-0">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6 p-0">
                        <div class="square bg-dark p-5">
                            <h2 class="text-white pt-5">What on earth are you doing here?</h2>
                            <p class="text-white pt-2 pb-5">Sorry, this page does not exist</p>
                            <div class="pb-5">
                                <a href="" class="bg-light py-2 px-4 text-dark">Go Back
                                    <svg width="16" height="16" class="ms-2" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-6 p-0">
                <img src="assets/image/photo-58.jpg" class="w-100" height="657px" alt="">
            </div>
        </div>
    </div>